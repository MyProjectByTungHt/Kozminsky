...
class AHT_CreatorModule_Block_Adminhtml_CreatorModule_Edit_Tab_AnswerGrid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        ...
        $collection->addFilter('parent_id', array('eq' => $this->getRequest()->getParam('id')));
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('creatormodule', array(
...
//        $this->addExportType('*/*/exportXml', Mage::helper('creatormodule')->__('XML'));
    ...
    protected function _prepareMassaction() {
        ...
        $this->getMassactionBlock()->addItem('delete', array(
            ...
            'url' => $this->getUrl('*/*/massDeleteAnswer'),
...
//        ));
    ...
    public function getRowUrl($row) {
        return $this->getUrl('*/adminhtml_answer/editanswer', array('id' => $row->getId(),'idQuestion'=>$this->getRequest()->getParam('id')));
    }

    public function getGridUrl() {
        return $this->getUrl('*/*/listanswer', array('_current'=>true));
    }
}
