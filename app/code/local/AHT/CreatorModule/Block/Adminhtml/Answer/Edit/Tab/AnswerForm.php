...
class AHT_CreatorModule_Block_Adminhtml_Answer_Edit_Tab_AnswerForm extends Mage_Adminhtml_Block_Widget_Form {

    protected function _prepareForm() {
//        echo '<pre>';print_r(Mage::registry('creatormodule_data')->getData());die();
        $form = new Varien_Data_Form();
        $this->setForm($form);
        $fieldset = $form->addFieldset('creatormodule_form', array('legend' => Mage::helper('creatormodule')->__('Answer information')));

        $fieldset->addField('content', 'editor', array(
            'name' => 'contentAnswer',
            'label' => Mage::helper('creatormodule')->__('Content Answer'),
            'title' => Mage::helper('creatormodule')->__('Content Answer'),
